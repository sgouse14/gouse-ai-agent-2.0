...
export const INITIAL_BOQ_ITEMS: BOQItem[] = [
  ...
  },
  {
    ...
    rate: 0,
    amount: 0,
    notes: 'Draft specification awaiting final vendor quotation (Missing unit rate)',
    stage: 'Finishes',
    status: 'estimated',
    materialComponent: 0.65,
    laborComponent: 0.35,
  ...
  },
  {
    ...
    rate: 68000,
    amount: 442000,
    notes: 'Fabricated I-sections & gusset plates (Mismatched unit: entered as m3 instead of MT)',
    stage: 'Superstructure',
    status: 'tendered',
    materialComponent: 0.85,
    laborComponent: 0.15,
