...
export const MARKET_BENCHMARK_CATALOG: MarketBenchmarkItem[] = [
  ...
  {
    key: 'synthetic_enamel_paint',
    name: 'Synthetic high-gloss enamel painting on MS grills, railings & doors (2 coats + red oxide primer)',
    category: 'Finishes',
    unit: 'sq.m',
    economyRate: 110,
    standardRate: 155,
    premiumRate: 210,
    luxuryRate: 285,
    source: 'Asian Paints Apcolite / Berger Luxol Gloss Index',
    description: 'De-greasing, wire-brushing, 1 coat zinc-chromate red oxide primer, and 2 coats high-gloss synthetic enamel paint on safety grills & railings.',
    materialComponent: 0.58,
    laborComponent: 0.35,
    equipmentComponent: 0.01,
    overheadComponent: 0.06,
    qtyPerSqFt: 0.065,
    keywords: ['enamel', 'synthetic enamel', 'grill paint', 'metal paint', 'railing paint', 'wood paint', 'apcolite', 'luxol'],
  },
  {
    key: 'white_cement_wall_putty',
    name: 'White cement-based polymer wall care putty (2 coats + mechanical orbital sanding)',
    category: 'Finishes',
    unit: 'sq.m',
    economyRate: 48,
    standardRate: 72,
    premiumRate: 98,
    luxuryRate: 135,
    source: 'Birla White Wall Care / JK WallMaxx CPWD DSR Index',
    description: 'Double coat skimming with white cement polymer wall putty, leveling plaster irregularities, and sanding with 320-grit paper.',
    materialComponent: 0.62,
    laborComponent: 0.32,
    equipmentComponent: 0.01,
    overheadComponent: 0.05,
    qtyPerSqFt: 0.18,
    keywords: ['putty', 'wall putty', 'skim coat', 'white cement putty', 'birla white', 'jk wall care', 'wallmaxx'],
  },
  {
    key: 'acrylic_wall_primer',
    name: 'Water-thinnable deep penetrating acrylic alkali-resistant wall primer',
    category: 'Finishes',
    unit: 'sq.m',
    economyRate: 32,
    standardRate: 48,
    premiumRate: 65,
    luxuryRate: 88,
    source: 'Asian Paints Decoprime / Berger BP Primer Index',
    description: '1 coat deep-penetrating water-based acrylic wall primer applied over cured plaster or sanded putty before painting.',
    materialComponent: 0.60,
    laborComponent: 0.33,
    equipmentComponent: 0.01,
    overheadComponent: 0.06,
    qtyPerSqFt: 0.18,
    keywords: ['primer', 'wall primer', 'acrylic primer', 'decoprime', 'base coat', 'sealer primer'],
  },
  {
    key: 'damp_proof_waterproofing_coating',
    ...
    premiumRate: 270,
    luxuryRate: 360,
    source: 'Asian Paints SmartCare Damp Proof / Dr. Fixit Newcoat ERS',
    description: 'Dual coat thick elastomeric liquid acrylic-polyurethane membrane on exterior parapets, chajjas, terrace floor-wall coves & bathroom wet dado.',
    materialComponent: 0.64,
    laborComponent: 0.28,
    equipmentComponent: 0.02,
    overheadComponent: 0.06,
    qtyPerSqFt: 0.045,
    keywords: ['damp proof', 'dampproof', 'waterproof coating', 'liquid membrane', 'smartcare', 'dr fixit', 'newcoat'],
  },
  {
    key: 'granite_slab_countertop',
    name: '18-20mm Jet Black pre-polished granite slab for kitchen countertops & sills',
    category: 'Finishes',
    unit: 'sq.ft',
    economyRate: 155,
    standardRate: 215,
    premiumRate: 295,
    luxuryRate: 420,
    source: 'South Indian Gangsaw Jet Black Granite Index',
    description: '18-20mm mirror-polished gangsaw granite slab bedded on polymer-modified cement mortar with half-bullnose edge moulding and fascia.',
    materialComponent: 0.68,
    laborComponent: 0.24,
    equipmentComponent: 0.02,
    overheadComponent: 0.06,
    qtyPerSqFt: 0.085,
    keywords: ['granite', 'black granite', 'kitchen counter', 'window sill', 'granite countertop', 'granite slab'],
  },
  {
    key: 'gypsum_false_ceiling',
    name: 'Gypsum board suspended false ceiling system with GI perimeter channels',
    category: 'Finishes',
    unit: 'sq.ft',
    economyRate: 85,
    standardRate: 118,
    premiumRate: 165,
    luxuryRate: 240,
    source: 'Saint-Gobain Gyproc / Armstrong Technical Index',
    description: '12.5mm tapered-edge moisture-resistant gypsum boards suspended on galvanized GI perimeter channels with joint tape, compound, and cove troughs.',
    materialComponent: 0.54,
    laborComponent: 0.38,
    equipmentComponent: 0.02,
    overheadComponent: 0.06,
    qtyPerSqFt: 0.65,
    keywords: ['false ceiling', 'gypsum', 'gyproc', 'ceiling', 'pop ceiling', 'suspended ceiling'],
  },
];
