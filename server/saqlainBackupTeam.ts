...
export const SAQLAIN_BACKUP_POLICY=Object.freeze({originalsRemainUntouched:true,deleteOriginals:false,overwriteOriginals:false,overwriteVerifiedBackups:false,externalAccess:false,exclusiveTaskLock:true,reportFlow:['queue-manager','saqlain-ai','gouse-ai'] as const});
...
export function buildReportRouting(report:BackupReport) { return {report,next:{queueManager:'received-and-validated',saqlain:'security-review',gouseAi:'final-review-after-saqlain'}} as const; }
